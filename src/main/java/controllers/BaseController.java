/*
    * Auhtor : Suraj Dakua
    * Date : 07/11/2020
    * Description : This class is responsible to load main application after login.
* */
...
public class BaseController implements Initializable{
    ...
    @FXML
    private JFXButton btnStaffBankDetails;
    @FXML
    ...
    @FXML
    private JFXButton btnRetailers;
    @FXML
    ...
    private void loadFXMLMap() {
        ...
        FXML_URL.put("Inventory", "/main/resources/view/inventory.fxml");
        FXML_URL.put("Staff", "/main/resources/view/staff.fxml");
        FXML_URL.put("Orders", "/main/resources/view/orders.fxml");
        FXML_URL.put("Retailers", "/main/resources/view/retailers.fxml");
        FXML_URL.put("Food", "/main/resources/view/food.fxml");
        FXML_URL.put("Staff Bank Details", "/main/resources/view/bank.fxml");
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        /* Controlling access by checking access level of user */
    ...
    private void logOut() {
        ...
        try {
            ...
            logInPrompt.show();
            logInPrompt.setTitle("CMS");
            logInPrompt.getIcons().add(new Image("/main/resources/icons/Accounts_main.png"));
